import { demoMessageLogs } from '@/data/demo';
...
export default function MessagesPage() {
  return (
    <div className="p-4 lg:p-6 space-y-6">
      ...
      <p className="text-sm text-muted-foreground">WhatsApp-style outbound message history</p>

      <div className="space-y-2">
        {demoMessageLogs.map((m, i) => (
